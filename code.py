...
data = pd.read_csv(r"C:\Users\ajith\Downloads\News (1).csv",index_col=0) 
data.head()
...
#we have to shuffle the dataset to prevent the model to get bias.
# Shuffling 
...
#unique values in the each category
